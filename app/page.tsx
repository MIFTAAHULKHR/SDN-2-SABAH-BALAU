      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-stretch">
          <div>
            ...
            <div className="relative w-full h-full object-cover rounded-xl shadow-xl overflow-hidden min-h-[300px]">
              <Image 
...
// <-- 3. Tentukan tipe untuk data statistik
interface StatItem {
  id: number;
  icon: React.ReactNode; // Tipe untuk ikon React
  number: string;
  label: string;
}
    ...
    <section className="py-12 lg:py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8">
          {statsData.map((stat) => ( // Tipe 'stat' sekarang sudah benar
            <div 
              key={stat.id} 
