...
// --- DATA KUIS UNTUK BAB 7 MTK KELAS 5 (BARU) ---
const quizQuestions = [
  {
...
// Kunci unik untuk localStorage (Diubah untuk MTK Bab 7)
...
export default function MateriMtk5Bab7Page() {
  ...
  // Link YouTube untuk Bab 7
  const videoEmbedUrl = "https://www.youtube.com/embed/IrX0y3Yf3HA?si=DwGNZ-tzI-sk-eaC";
  const videoTitle = "Materi Bab 7: Kelipatan dan Faktor";
