...
// --- DATA KUIS UNTUK BAB 8 MTK KELAS 5 (BARU) ---
const quizQuestions = [
  {
...
export default function MateriMtk5Bab8Page() {
  ...
  // Link YouTube untuk Bab 8
  const videoEmbedUrl = "https://www.youtube.com/embed/uCHIH8DnNEs?si=JuShia8oDeltuZu1";
  const videoTitle = "Materi Bab 8: Pecahan";
