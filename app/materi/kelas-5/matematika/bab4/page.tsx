...
// --- DATA KUIS UNTUK BAB 4 MTK KELAS 5 (BARU) ---
const quizQuestions = [
  {
...
// Kunci unik untuk localStorage (Diubah untuk MTK Bab 4)
...
export default function MateriMtk5Bab4Page() {
  ...
  // Link YouTube untuk Bab 4
  const videoEmbedUrl = "https://www.youtube.com/embed/w_nvlUki150?si=APm6WkQhV-EOgfZV";
  const videoTitle = "Materi Bab 4: Kekongruenan dan Sudut Bangun Datar";
  ...
  return (
    <div className="bg-white min-h-screen flex flex-col">
      <Navbar />
      {/* PERBAIKAN RESPONSIVITAS: Padding (py) dikecilkan untuk HP */}
      <main className="py-10 md:py-16 flex-grow">
        <div className="container mx-auto px-4">
          ...
          <h2 className="text-2xl md:text-3xl font-semibold text-slate-700 text-center mb-10 md:mb-12">
            Kekongruenan dan Sudut Bangun Datar
          </h2>
