...
// --- DATA KUIS UNTUK BAB 3 (BARU) ---
const quizQuestions = [
  {
    question: "1. 'How much is the apple?' Kalimat ini menanyakan...",
    options: ["Rasa", "Jumlah", "Harga"],
    correctAnswer: "Harga"
  },
  {
    question: "2. 'It is five thousand rupiahs.' Angka yang benar adalah...",
    options: ["Rp 500", "Rp 5.000", "Rp 50.000"],
    correctAnswer: "Rp 5.000"
  },
  {
    question: "3. How much ... the bananas? (Pisangnya lebih dari satu)",
    options: ["is", "are", "am"],
    correctAnswer: "are"
  },
  {
    question: "4. 'They are twenty thousand rupiahs.' Angka yang benar adalah...",
    options: ["Rp 2.000", "Rp 20.000", "Rp 200.000"],
    correctAnswer: "Rp 20.000"
  },
  {
    question: "5. 'One hundred thousand' artinya...",
    options: ["10.000", "1.000.000", "100.000"],
    correctAnswer: "100.000"
  },
  {
    question: "6. A: How much is the book? B: ... is Rp 15.000.",
    options: ["It", "They", "He"],
    correctAnswer: "It"
  },
  {
    question: "7. A: How much are the shoes? B: ... are Rp 75.000.",
    options: ["It", "They", "She"],
    correctAnswer: "They"
  },
  {
    question: "8. 'Fifty thousand' artinya...",
    options: ["15.000", "50.000", "500.000"],
    correctAnswer: "50.000"
  },
  {
    question: "9. Kata 'Cost' dalam 'How much do the apples cost?' memiliki arti...",
    options: ["Harga/Biaya", "Beli", "Jual"],
    correctAnswer: "Harga/Biaya"
  },
  {
    question: "10. 'Two hundred and fifty' artinya...",
    options: ["205", "250", "2050"],
    correctAnswer: "250"
  }
];

// Kunci unik untuk localStorage (Diubah untuk BAB 3)
...
export default function MateriBing5Bab3Page() {
  ...
  const videoEmbedUrl = "https://www.youtube.com/embed/hKVmpL5C5Dc?si=oxcl52qJgTkX6WzL"; 
