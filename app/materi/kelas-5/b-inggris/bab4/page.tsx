...
// --- DATA KUIS UNTUK BAB 4 (BARU) ---
const quizQuestions = [
  {
    question: "1. 'I have a stomachache.' What does 'stomachache' mean?",
    options: ["Sakit kepala", "Sakit gigi", "Sakit perut"],
    correctAnswer: "Sakit perut"
  },
  {
    question: "2. If you have a 'fever', you feel ...",
    options: ["Cold", "Hot", "Tired"],
    correctAnswer: "Hot"
  },
  {
    question: "3. 'I have a toothache.' You should go to the ...",
    options: ["Doctor", "Dentist", "Teacher"],
    correctAnswer: "Dentist"
  },
  {
    question: "4. What's the matter? I have a ... (flu)",
    options: ["Cough", "Headache", "Flu"],
    correctAnswer: "Flu"
  },
  {
    question: "5. 'He has a broken leg.' 'Broken leg' means...",
    options: ["Kaki terkilir", "Kaki patah", "Kaki lecet"],
    correctAnswer: "Kaki patah"
  },
  {
    question: "6. 'I have a headache.' 'Headache' means...",
    options: ["Sakit kepala", "Sakit mata", "Sakit telinga"],
    correctAnswer: "Sakit kepala"
  },
  {
    question: "7. 'She has a cough.' 'Cough' means...",
    options: ["Pilek", "Batuk", "Demam"],
    correctAnswer: "Batuk"
  },
  {
    question: "8. 'I feel dizzy.' 'Dizzy' means...",
    options: ["Pusing", "Mual", "Lelah"],
    correctAnswer: "Pusing"
  },
  {
    question: "9. We use our ... to see.",
    options: ["Nose", "Eyes", "Ears"],
    correctAnswer: "Eyes"
  },
  {
    question: "10. 'I have a sore throat.' 'Sore throat' means...",
    options: ["Sakit gigi", "Sakit punggung", "Sakit tenggorokan"],
    correctAnswer: "Sakit tenggorokan"
  }
];

// Kunci unik untuk localStorage (Diubah untuk BAB 4)
