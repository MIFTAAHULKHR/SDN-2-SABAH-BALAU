...
// Kunci unik untuk localStorage (Diubah untuk BAB 6)
...
export default function MateriBing5Bab6Page() {
  ...
  const videoEmbedUrl = "https://www.youtube.com/embed/E1RaVPoA5ns?si=lbh9WcoccZDWg1OL";
  const videoTitle = "Materi Bab 6: She Listens to Music with Her Ears";
