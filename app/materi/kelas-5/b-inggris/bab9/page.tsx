...
// Kunci unik untuk localStorage (Diubah untuk BAB 9)
...
export default function MateriBing5Bab9Page() {
  ...
  // Video baru untuk Superlative Adjectives
  const videoEmbedUrl = "https://www.youtube.com/embed/S98-IIF-Tq4";
  const videoTitle = "Materi Bab 9: The Giraffe is the Tallest Animal on Earth";
