...
// Kunci unik untuk localStorage (Diubah untuk BAB 5)
...
export default function MateriBing5Bab5Page() {
  ...
  const videoEmbedUrl = "https://www.youtube.com/embed/nW_bdk8e51o?si=MdiLMOtIgeaZcD9y";
  const videoTitle = "Materi Bab 5: What a Nice Shirt!";
