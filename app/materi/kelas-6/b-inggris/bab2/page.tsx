...
// --- DATA KUIS UNTUK BAB 2 B. INGGRIS KELAS 6 (BARU) ---
const quizQuestions = [
  {
...
// Kunci unik untuk localStorage (Diubah untuk BING KELAS 6 BAB 2)
...
export default function MateriBing6Bab2Page() {
  ...
  const videoEmbedUrl = "https://www.youtube.com/embed/dgTThLJnlTQ";
  const videoTitle = "Materi Bab 2: I Went to the Zoo Last Week";
