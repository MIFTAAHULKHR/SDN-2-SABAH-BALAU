...
// --- DATA KUIS UNTUK BAB 8 B. INGGRIS KELAS 6 (BARU) ---
const quizQuestions = [
  {
...
// Kunci unik untuk localStorage (Diubah untuk BING KELAS 6 BAB 8)
...
export default function MateriBing6Bab8Page() {
  ...
  const videoEmbedUrl = "https://www.youtube.com/embed/RMd-6Zp_p6U";
  const videoTitle = "Materi Bab 8: My Mother will Bake a Cake Tomorrow";
