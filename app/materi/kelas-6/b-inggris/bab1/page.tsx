...
// --- DATA KUIS UNTUK BAB 1 KELAS 6 (BARU) ---
const quizQuestions = [
  {
...
// Kunci unik untuk localStorage (Diubah untuk KELAS 6 BAB 1)
...
export default function MateriBing6Bab1Page() {
  ...
  const videoEmbedUrl = "https://www.youtube.com/embed/ss-AMasNuDw?si=EC4Nygm38Z5CsQu9";
  const videoTitle = "Materi Bab 1: I Ate Hamburger Yesterday";
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mt-8 md:mt-12">
              <Link 
                href="/akademik/kelas-6/bahasa-inggris" // PERBAIKAN: Link kembali ke kelas 6
